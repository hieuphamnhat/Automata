...
static const char *const yytname[] =
{
  ...
  "MINUS", "TIMES", "DIVIDE", "$accept", "Input", "Line", "Expression", YY_NULLPTR
};
#endif
...
#line 38 "calc.y" /* yacc.c:1646  */
    {sscanf((yyvsp[-2].name), "%s", var_name); value = (yyvsp[0].val);}
#line 1228 "calc.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 39 "calc.y" /* yacc.c:1646  */
    { checkName((yyvsp[-2].name)); value = value + (yyvsp[0].val); }
...
#line 42 "calc.y" /* yacc.c:1646  */
    { checkName((yyvsp[-2].name)); if((yyvsp[0].val) == 0){printf("error"); exit(1);}; value = value/(yyvsp[0].val); }
